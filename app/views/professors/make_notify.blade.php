...
<script type="text/javascript">
   ...
   {
        window.location="make_notify="+ sel.value ;
   }
...
<div class="row">
	...
	<div class="panel-heading">
			 ...
			 <form role="form" class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data" action="make_notify={{$kind}}">
...
<?php
                        ...
                        $prof_id=$view_courses->view("professor","where_pluck","Mail","=",$tea->user_session,"id");
                        $courses = $view_courses->view('prof_course','where_get','prof_id','=',$prof_id,'');
 					...
 					?>
 						...
 						<div class="col-sm-4">
 							...
 							<select class="selectboxit visible" data-first-option="false" style="display: none;" name="courses"  required >
 								...
 								<option value="<?php echo $cor->course_id ; ?>"><?php echo  $view_courses->view("course","where_pluck","id","=",$cor->course_id,"name"); ?></option>
 								<?php } ?>
 							</select>
